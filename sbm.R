...
# stochastic bisection method for convex function with first-order oracle.
# oracle takes position x, and returns a unbiased estimate of the derivative at x.
# sbm starts binary search from initial interval (start.left, start.right),
# until either epoch exceeds end.epoch or total number of queries exceeds budget.
